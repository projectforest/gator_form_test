...
public class MultipleFieldForm {
  ...
  @Test
  public void testMultipleFieldForm() throws Exception {
    ...
    driver.findElement(By.id("pweb-location-after")).click();
    driver.findElement(By.id("pweb_params_effect_modal_smooth")).click();
    driver.findElement(By.id("pweb-tab-fields")).click();
    driver.findElement(By.id("pweb_load_fields")).click();
    new Select(driver.findElement(By.id("pweb_load_fields"))).selectByVisibleText("Multiple fields");
    driver.findElement(By.id("pweb_load_fields")).click();
    driver.findElement(By.xpath("(//button[@type='button'])[62]")).click();
    driver.findElement(By.id("title")).clear();
    driver.findElement(By.id("title")).sendKeys("multiple field form");
