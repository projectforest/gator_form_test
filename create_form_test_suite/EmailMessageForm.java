...
public class EmailMessageForm {
  ...
  @Test
  public void testEmailMessageForm() throws Exception {
    ...
    new Select(driver.findElement(By.id("pweb_load_fields"))).selectByVisibleText("Email message");
    driver.findElement(By.id("pweb_load_fields")).click();
    driver.findElement(By.xpath("//div[138]/div[3]/div/button/span")).click();
    driver.findElement(By.id("title")).click();
    driver.findElement(By.id("title")).clear();
    driver.findElement(By.id("title")).sendKeys("Email message form");
