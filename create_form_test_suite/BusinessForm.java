...
public class BusinessForm {
  ...
  @Test
  public void testBusinessForm() throws Exception {
    ...
    new Select(driver.findElement(By.id("pweb_load_fields"))).selectByVisibleText("Business form");
    driver.findElement(By.id("pweb_load_fields")).click();
    driver.findElement(By.xpath("//div[138]/div[3]/div/button/span")).click();
    driver.findElement(By.id("title")).clear();
    driver.findElement(By.id("title")).sendKeys("business form");
    driver.findElement(By.xpath("//a[@id='pweb-tab-theme']/i")).click();
