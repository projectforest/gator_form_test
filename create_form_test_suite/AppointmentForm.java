...
public class AppointmentForm {
  ...
  @Test
  public void testAppointmentForm() throws Exception {
    ...
    new Select(driver.findElement(By.id("pweb_load_fields"))).selectByVisibleText("Appointment");
    driver.findElement(By.id("pweb_load_fields")).click();
    driver.findElement(By.xpath("//div[138]/div[3]/div/button/span")).click();
    driver.findElement(By.id("title")).clear();
    driver.findElement(By.id("title")).sendKeys("appointment form");
    driver.findElement(By.id("pweb-tabs")).click();
