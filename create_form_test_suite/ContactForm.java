...
public class ContactForm {
  ...
  public void testContactForm() throws Exception {
    ...
    new Select(driver.findElement(By.id("pweb_load_fields"))).selectByVisibleText("Contact form (FREE)");
    driver.findElement(By.id("pweb_load_fields")).click();
    driver.findElement(By.xpath("//div[138]/div[3]/div/button/span")).click();
    driver.findElement(By.id("pweb-tab-theme")).click();
    driver.findElement(By.xpath("//button[@id='pweb-themes-coverflow-control-next']/i")).click();
    driver.findElement(By.xpath("//button[@id='pweb-themes-coverflow-control-next']/i")).click();
    driver.findElement(By.xpath("//button[@id='pweb-themes-coverflow-control-next']/i")).click();
    // ERROR: Caught exception [ERROR: Unsupported command [doubleClick | //button[@id='pweb-themes-coverflow-control-next']/i | ]]
    driver.findElement(By.xpath("//button[@id='pweb-themes-coverflow-control-next']/i")).click();
