...
public class CallMeBackForm {
  ...
  @Test
  public void testCallMeBackForm() throws Exception {
    ...
    new Select(driver.findElement(By.id("pweb_load_fields"))).selectByVisibleText("Call me back");
    driver.findElement(By.id("pweb_load_fields")).click();
    ...
    driver.findElement(By.id("title")).sendKeys("call me back form");
